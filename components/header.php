<header class="header">
    <section class="flex">
        ...
        <form action="search_page.php" method="POST" class="search-form">
            <input type="text" placeholder="Cari disini..." maxlength="100" name="search-box">
        ...
        <div class="profile">
            ...
            if ($num_rows > 0) {
                // Fetch hasil jika ada baris yang dikembalikan
                $fetch_profile = $result->fetch_assoc();
            ?>
                <img src="../uploaded_files/<?= $fetch_profile['gambar']; ?>" alt="">
