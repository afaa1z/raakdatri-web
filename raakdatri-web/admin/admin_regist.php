...
<body>
    ...
    <!-- form daftar admin mulai -->
    <section class="form-container">
        <form action="" method="POST" enctype="multipart/form-data">
            <h3>Daftar Sebagai Admin</h3>
            <p>Pendaftaran admin hanya bisa dilakukan oleh karyawan yang telah terdaftar pada database</p>
            ...
            <input type="email" name="email" maxlength="50" required placeholder="masukkan email anda" class="box" oninput="this.value = this.value.replace(/\s/g,'')">
            <input type="text" name="noPegawai" maxlength="50" required placeholder="masukkan nomor pegawai anda" class="box" oninput="this.value = this.value.replace(/\s/g,'')">
            ...
            <p>Sudah jadi admin? <a href="admin_login.php">Login</a></p>
            <input type="submit" value="daftar" name="submit" class="btn">
        </form>
    </section>
    <!-- form daftar admin selesai -->
</body>
